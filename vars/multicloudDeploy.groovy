...
void call(parameters = [:]) {
    ...
    handlePipelineStepErrors(stepName: STEP_NAME, stepParameters: parameters) {
        ...
        if (config.cfCreateServices) {
            ...
            runClosures(closures: createServices, parallelExecution: config.parallelExecution, label: "cloudFoundryCreateService", script: script)
        }
        ...
        runClosures(closures: deployments, parallelExecution: config.parallelExecution, label: "deployments", script: script)
    }
}
